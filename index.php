...
<header id="header" class="d-flex align-items-center bg-success ">
    <div class="container-fluid container-xxl d-flex align-items-center">
        ...
        <a class="buy-tickets scrollto" href="#buy-tickets">Conference fee(S)</a>
...
<section id="hero">
    <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
        <div class="mt-5">
            <h1 class="mb-4 pb-0">SPAS 6th<br><span>National</span> Conference</h1>
            <p class="mb-4 pb-0">03-04 October, Virtual (Zoom), </p>
        </div>
        <div>
            <h1 class="mb-4 pb-0" style="font-size: 2rem;">"Sustaining Scienctific and Technological Innovations for the
                21st Century Industrial
                And Economic Development"</h1>
        </div>
    ...
    <section id="about">
        <div class="container position-relative" data-aos="fade-up">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <h3>Where</h3>
                    <p>The Federal Polytechnic, Ilaro, Oja Odan Road, Ogun State.</p>
                </div>
                <div class="col-lg-3">
                    <h3>When</h3>
    ...
    <section id="speakers">
        <div class="container" data-aos="fade-up">
            <div class="section-header">
                ...
                <p>Here are some of our Guests</p>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="speaker" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="details">
                            <h3><a href="speaker-details.html">Dr. M.A. Akinde</a></h3>
                            <p>The Rector, Federal Polytechnic Ilaro, Ogun State</p>
                            <small class="text-white">Chief Host</small>
                            <div class="social">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="speaker" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="details">
                            <h3><a href="speaker-details.html">Mr. O.M. Makanjuola</a></h3>
                            <p>Dean, School Of Pure And Applied Science</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="speaker" data-aos="fade-up" data-aos-delay="300">
                        ...
                        <div class="details">
                            <h3><a href="speaker-details.html">Prof. Z.O. Omogbadegun</a></h3>
                            <p>Augustine Univerity, Ilaro-Epe, Lagos.</p>
                            <small class="text-white">Keynote Speaker</small>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
                                <a href=""><i class="bi bi-facebook"></i></a>
                                <a href=""><i class="bi bi-instagram"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="speaker" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <div class="details">
                            <h3><a href="speaker-details.html">Dr. O.S. Kolawo-Joseph</a></h3>
                            <p>Department of Biological Science, Yaba College of Technology, Yaba Lagos</p>
                            <small class="text-white">Lead Paper Presenter</small>
                            <div class="social">
                                <a href=""><i class="bi bi-twitter"></i></a>
                                <a href=""><i class="bi bi-facebook"></i></a>
                                <a href=""><i class="bi bi-instagram"></i></a>
    ...
    <section id="venue">
        ...
        <div class="container-fluid" data-aos="fade-up">
            ...
            <div class="row g-0">
                <div class="col-lg-6 venue-map">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15843.873431046359!2d2.9639178!3d6.8943883!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b09038efa1efb%3A0x26a1b508bfba7652!2sThe%20Federal%20Polytechnic%2C%20Ilaro!5e0!3m2!1sen!2sng!4v1691254966350!5m2!1sen!2sng"
        ...
        <div class="container-fluid venue-gallery-container" data-aos="fade-up" data-aos-delay="100">
            <div class="row g-0">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="venue-gallery">
                        <a href="assets/img/venue-gallery/.jpg" class="glightbox" data-gall="venue-gallery">
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                    <div class="card mb-5 mb-lg-0">
                        <div class="card-body">
                            ...
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Payment Method:</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Account Name: SPAS Conference
                                Account</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Account Number: 2060220295</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Bank: UBA</li>

                            <hr>
                            <div class="text-center">
                                <button type="button" class="btn" data-bs-toggle="modal"
                                    data-bs-target="#buy-ticket-modal" data-ticket-type="pro-access">PAY</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row contact-info">
                ...
                <div class="col-md-4">
                    <div class="contact-address">
                        ...
                        <h3>Address</h3>
                        <address>THE FEDERAL POLYTECHNIC ILARO PMB 50, ILARO, OGUN STATE.</address>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="contact-phone">
                        ...
                        <h3>Phone Number</h3>
                        <p><a href="tel:+155895548855">+23481 234 567 8900</a></p>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="contact-email">
                        ...
                        <h3>Email</h3>
                        <p><a href="mailto:info@example.com">info@federalpolyilaro.edu.ng</a></p>
                    </div>
                </div>
